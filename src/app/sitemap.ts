...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/tools/emergency`, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/tools/menu`, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/tools/transport`, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/tools/trip-map`, changeFrequency: "monthly", priority: 0.9 },
